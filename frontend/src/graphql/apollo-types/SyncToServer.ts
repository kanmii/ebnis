...
import { UpdateExperienceInput, CreateExperienceInput, DataTypes } from "./globalTypes";
...
export interface SyncToServer_updateExperiences_UpdateExperiencesSomeSuccess_experiences_UpdateExperienceSomeSuccess_experience {
  ...
  updatedDefinitions: SyncToServer_updateExperiences_UpdateExperiencesSomeSuccess_experiences_UpdateExperienceSomeSuccess_experience_updatedDefinitions[] | null;
}
...
export interface SyncToServer_updateExperiences_UpdateExperiencesSomeSuccess_experiences_UpdateExperienceSomeSuccess_entries_newEntries_CreateEntryErrors_errors {
   ...
   */
  dataObjects: (SyncToServer_updateExperiences_UpdateExperiencesSomeSuccess_experiences_UpdateExperienceSomeSuccess_entries_newEntries_CreateEntryErrors_errors_dataObjects | null)[] | null;
}
...
export interface SyncToServer_updateExperiences_UpdateExperiencesSomeSuccess_experiences_UpdateExperienceSomeSuccess_entries {
  ...
  updatedEntries: SyncToServer_updateExperiences_UpdateExperiencesSomeSuccess_experiences_UpdateExperienceSomeSuccess_entries_updatedEntries[] | null;
  newEntries: SyncToServer_updateExperiences_UpdateExperiencesSomeSuccess_experiences_UpdateExperienceSomeSuccess_entries_newEntries[] | null;
  deletedEntries: SyncToServer_updateExperiences_UpdateExperiencesSomeSuccess_experiences_UpdateExperienceSomeSuccess_entries_deletedEntries[] | null;
}
...
export type SyncToServer_updateExperiences_UpdateExperiencesSomeSuccess_experiences = SyncToServer_updateExperiences_UpdateExperiencesSomeSuccess_experiences_UpdateExperienceErrors | SyncToServer_updateExperiences_UpdateExperiencesSomeSuccess_experiences_UpdateExperienceSomeSuccess;
...
export type SyncToServer_updateExperiences = SyncToServer_updateExperiences_UpdateExperiencesAllFail | SyncToServer_updateExperiences_UpdateExperiencesSomeSuccess;
...
export interface SyncToServer_createExperiences_ExperienceSuccess_entries_CreateEntryErrors_errors {
   ...
   * Did we fail because there are errors in the data object object?
   */
  dataObjects: (SyncToServer_createExperiences_ExperienceSuccess_entries_CreateEntryErrors_errors_dataObjects | null)[] | null;
}
...
export type SyncToServer_createExperiences_ExperienceSuccess_entries = SyncToServer_createExperiences_ExperienceSuccess_entries_CreateEntrySuccess | SyncToServer_createExperiences_ExperienceSuccess_entries_CreateEntryErrors;
...
export interface SyncToServer_createExperiences_CreateExperienceErrors_errors {
  ...
  user: string | null;
  clientId: string | null;
  dataDefinitions: (SyncToServer_createExperiences_CreateExperienceErrors_errors_dataDefinitions | null)[] | null;
}
...
export type SyncToServer_createExperiences = SyncToServer_createExperiences_ExperienceSuccess | SyncToServer_createExperiences_CreateExperienceErrors;
