...
export interface CreateExperiences_createExperiences_ExperienceSuccess_experience_comments {
  __typename: "Comment";
  id: string;
  text: string;
}
...
export interface CreateExperiences_createExperiences_ExperienceSuccess_experience {
   ...
   */
  comments:
    | (CreateExperiences_createExperiences_ExperienceSuccess_experience_comments | null)[]
    | null;
}
...
export interface CreateExperiences_createExperiences_ExperienceSuccess_entries_CreateEntryErrors_errors {
   ...
   */
  dataObjects:
    | (CreateExperiences_createExperiences_ExperienceSuccess_entries_CreateEntryErrors_errors_dataObjects | null)[]
    | null;
}
...
export type CreateExperiences_createExperiences_ExperienceSuccess_entries =
  | CreateExperiences_createExperiences_ExperienceSuccess_entries_CreateEntrySuccess
  | CreateExperiences_createExperiences_ExperienceSuccess_entries_CreateEntryErrors;
...
export interface CreateExperiences_createExperiences_ExperienceSuccess {
  ...
  entries:
    | CreateExperiences_createExperiences_ExperienceSuccess_entries[]
    | null;
}
...
export interface CreateExperiences_createExperiences_CreateExperienceErrors_errors {
  ...
  clientId: string | null;
  dataDefinitions:
    | (CreateExperiences_createExperiences_CreateExperienceErrors_errors_dataDefinitions | null)[]
    | null;
}
...
export type CreateExperiences_createExperiences =
