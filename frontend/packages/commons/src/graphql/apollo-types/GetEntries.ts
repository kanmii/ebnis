...
export interface GetEntries_getEntries_GetEntriesSuccess_entries {
  ...
  edges:
    | (GetEntries_getEntries_GetEntriesSuccess_entries_edges | null)[]
    | null;
}
...
export type GetEntries_getEntries =
  | GetEntries_getEntries_GetEntriesSuccess
  | GetEntries_getEntries_GetEntriesErrors;
