...
export type UpdateExperienceFragment_ownFields =
  | UpdateExperienceFragment_ownFields_UpdateExperienceOwnFieldsErrors
  | UpdateExperienceFragment_ownFields_ExperienceOwnFieldsSuccess;
...
export type UpdateExperienceFragment_updatedDefinitions =
  | UpdateExperienceFragment_updatedDefinitions_DefinitionErrors
  | UpdateExperienceFragment_updatedDefinitions_DefinitionSuccess;
