...
export interface GetDetailExperience_getEntries_GetEntriesSuccess_entries {
  ...
  edges:
    | (GetDetailExperience_getEntries_GetEntriesSuccess_entries_edges | null)[]
    | null;
}
...
export type GetDetailExperience_getEntries =
  | GetDetailExperience_getEntries_GetEntriesSuccess
  | GetDetailExperience_getEntries_GetEntriesErrors;
