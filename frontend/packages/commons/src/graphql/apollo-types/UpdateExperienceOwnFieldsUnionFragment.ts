...
export type UpdateExperienceOwnFieldsUnionFragment =
  | UpdateExperienceOwnFieldsUnionFragment_UpdateExperienceOwnFieldsErrors
  | UpdateExperienceOwnFieldsUnionFragment_ExperienceOwnFieldsSuccess;
