import { LOGIN_URL } from "@ebnis/cra/src/utils/urls";
import { LOGIN_PAGE_TITLE } from "@ebnis/cra/src/components/Login/login.dom";
import {
  passwordInputId,
  emailInputId,
  submitId,
  notificationId,
} from "@ebnis/cra/src/components/Login/login.dom";
import { MY_TITLE } from "@ebnis/cra/src/components/My/my.dom";
