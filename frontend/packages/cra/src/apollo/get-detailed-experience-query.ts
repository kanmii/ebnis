...
import { EXPERIENCE_FRAGMENT } from "@ebnis/commons/src/graphql/experience.gql";
import { makeApolloCacheRef } from "./resolvers";
import {
  GetExperience,
  GetExperienceVariables,
} from "@ebnis/commons/src/graphql/apollo-types/GetExperience";
import { GET_EXPERIENCE_QUERY } from "@ebnis/commons/src/graphql/experience.gql";
import { DetailedExperienceQueryResult } from "../utils/experience.gql.types";
import { GET_ENTRIES_QUERY } from "@ebnis/commons/src/graphql/experience.gql";
import {
  GetEntries,
  GetEntriesVariables,
...
import { emptyPageInfo } from "@ebnis/commons/src/graphql/utils.gql";
import { GetEntriesUnionFragment } from "@ebnis/commons/src/graphql/apollo-types/GetEntriesUnionFragment";
import { EntryFragment } from "@ebnis/commons/src/graphql/apollo-types/EntryFragment";
import { ENTRY_FRAGMENT } from "@ebnis/commons/src/graphql/entry.gql";
