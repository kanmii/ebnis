...
import {
  ...
  ExperienceFragment,
} from "@ebnis/commons/src/graphql/apollo-types/ExperienceFragment";
import { GET_COMPLETE_EXPERIENCE_QUERY } from "@ebnis/commons/src/graphql/experience.gql";
import {
...
import { CreateExperiencesVariables } from "@ebnis/commons/src/graphql/apollo-types/CreateExperiences";
import { v4 } from "uuid";
...
} from "@ebnis/commons/src/graphql/utils.gql";
