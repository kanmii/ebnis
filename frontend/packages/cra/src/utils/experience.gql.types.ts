...
import { UpdateExperienceInput } from "@ebnis/commons/src/graphql/apollo-types/globalTypes";
import {
  CommonError,
  OnlineStatus, //
} from "../utils/types";
...
} from "@ebnis/commons/src/graphql/apollo-types/DeleteExperiences";
import {
  GetDetailExperience,
  GetDetailExperienceVariables,
} from "@ebnis/commons/src/graphql/apollo-types/GetDetailExperience";
import {
...
import { OnExperiencesDeletedSubscription } from "@ebnis/commons/src/graphql/apollo-types/OnExperiencesDeletedSubscription";
...
import { ExperienceMiniFragment } from "@ebnis/commons/src/graphql/apollo-types/ExperienceMiniFragment";
import { UpdateExperienceSomeSuccessFragment } from "@ebnis/commons/src/graphql/apollo-types/UpdateExperienceSomeSuccessFragment";
import {
  GetEntries,
  GetEntriesVariables,
} from "@ebnis/commons/src/graphql/apollo-types/GetEntries";
import {
  PreFetchExperiences,
  PreFetchExperiencesVariables,
} from "@ebnis/commons/src/graphql/apollo-types/PreFetchExperiences";
import {
  GetExperienceVariables,
  GetExperience,
} from "@ebnis/commons/src/graphql/apollo-types/GetExperience";
import {
  GetDataObjectsVariables,
  GetDataObjects,
} from "@ebnis/commons/src/graphql/apollo-types/GetDataObjects";
