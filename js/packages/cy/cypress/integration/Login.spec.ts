import { LOGIN_URL } from "@eb/cra/src/utils/urls";
import { LOGIN_PAGE_TITLE } from "@eb/cra/src/components/Login/login.dom";
import {
  passwordInputId,
  emailInputId,
  submitId,
  notificationId,
} from "@eb/cra/src/components/Login/login.dom";
import { MY_TITLE } from "@eb/cra/src/components/My/my.dom";
