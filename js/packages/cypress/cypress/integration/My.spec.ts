  ...
  describe("update experience", () => {
    ...
    it("updates online", () => {
      ...
      cy.wrap<Promise<ExperienceDCFragment[]>, ExperienceDCFragment[]>(p).then(
        (unwrapped) => {
          const [experience1, experience2] = unwrapped;
    ...
    it("updates offline", () => {
      ...
      const promises = createOnlineExperienceCy([
        {
          title: "t1",
          dataDefinitions,
        },
      ...
      cy.wrap<Promise<ExperienceDCFragment[]>, ExperienceDCFragment[]>(
        promises,
      ).then((unwrapped) => {
        const [experience1, experience2] = unwrapped;
