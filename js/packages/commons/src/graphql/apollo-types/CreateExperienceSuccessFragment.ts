...
export interface CreateExperienceSuccessFragment_experience_comments {
  __typename: "Comment";
  id: string;
  text: string;
}
...
export interface CreateExperienceSuccessFragment_experience {
   ...
   */
  comments:
    | (CreateExperienceSuccessFragment_experience_comments | null)[]
    | null;
}
...
export interface CreateExperienceSuccessFragment_entries_CreateEntryErrors_errors {
   ...
   */
  dataObjects:
    | (CreateExperienceSuccessFragment_entries_CreateEntryErrors_errors_dataObjects | null)[]
    | null;
}
...
export type CreateExperienceSuccessFragment_entries =
  | CreateExperienceSuccessFragment_entries_CreateEntrySuccess
  | CreateExperienceSuccessFragment_entries_CreateEntryErrors;
